...
class Dno(games.Sprite):

    image = games.load_image("dno.bmp", transparent= False)
    def __init__(self):
        super(Dno, self).__init__(image = Dno.image,
                                  left = 0, bottom = 480)
